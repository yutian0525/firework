<template>
    ...
    :style="{
        ...
        <span class="span">{{ fireworkTitle }}</span>
        <div class="msgwrap">
...
import typerwriter from './typewriter.vue'
...
const startcanvas = () => {
    ...
    let rocketSettings = { size: 3, spawnRate: 1 }; //控制发射时的大小、数量
    let explosionSettings = { size:  3, fadeSpeed: 4, applyGravity: false }; //控制爆炸后的高斯模糊、大小、重力效果
